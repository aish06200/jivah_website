    ...
    >
      <div className="site-pad">
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-end lg:gap-12">
          <div>
            <p className="text-[13px] font-medium tracking-[0.12em] text-forest uppercase">
              How we can help
            </p>
          ...
          <p className="body-lede max-w-md text-[17px] text-muted lg:pb-1">
        ...
        <div className="relative mt-10 overflow-hidden rounded-[32px] border border-line/70 bg-white shadow-[0_28px_90px_rgba(18,22,29,0.08)] md:mt-12">
              ...
              >
                <div className="relative min-h-[300px] overflow-hidden sm:min-h-0 sm:aspect-[16/10] lg:aspect-auto lg:h-full">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center md:p-8 lg:p-10">
                    <p className="text-[11px] font-semibold tracking-[0.12em] text-[#7dffb8] uppercase">
                      {path.eyebrow}
                    </p>
                    <h3 className="card-title mt-2 text-[22px] leading-[1.12] text-white md:text-[42px] md:leading-[1.08] lg:text-[46px]">
                      {path.title}
                    </h3>
                    <p className="body-lede mt-2 text-[17px] text-white/80 md:mt-2.5 md:text-[19px]">
                      {path.description}
                    </p>
          ...
          <div className="pointer-events-none absolute top-1/2 left-1/2 z-20 hidden size-11 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-line bg-white text-[12px] font-semibold tracking-[0.08em] text-muted uppercase shadow-sm lg:flex">
            or
          </div>
        </div>
      </div>
